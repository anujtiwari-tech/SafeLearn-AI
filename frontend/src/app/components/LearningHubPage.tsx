...
export function LearningHubPage() {
  ...
  const earnedBadgesCount = (progress?.badges_earned.length || 0) + (completedQuizzes >= 5 ? 1 : 0);
    ...
    <div className="space-y-6 animate-in fade-in duration-500">
          ...
          <CardContent className="pt-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-600 dark:text-gray-400">Badges in Collection</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <Card className="border-2 shadow-sm">
        <CardHeader className="bg-gray-50/50 border-b dark:bg-slate-800">
          ...
          <CardDescription>Earn badges by completing lessons, quizzes, and maintaining streaks</CardDescription>
        </CardHeader>
        <CardContent className="pt-6">
              ...
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <p className="text-xs opacity-80 leading-relaxed italic">
                    "Knowledge is the best defense. Each lesson and quiz you complete increases your security resilience."
                  </p>
                </div>
              </div>
            </CardContent>
